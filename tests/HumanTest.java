...
public class HumanTest{
  ...
  public void test_getter_Shot() {
    ...
    int[] coord = test.getShot();
    coord[0] = 5;
    coord[1] = 3;

    assertNotEquals("Shot y was not copied, privacy leak", 5, test.getShot()[0]);
    assertNotEquals("Shot x was not copied, privacy leak", 3, test.getShot()[1]);
  }
  ...
  public void test_privacy_getter_shot() {
    ...
    assertNotEquals("Privacy leak occurred when retrieving shot coordinates", 6, test.getShot()[0]);
  }
